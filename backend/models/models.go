...
type HomeContent struct {
	...
	HeroStat3Number     string    `json:"hero_stat3_number"`
	HeroStat3Label      string    `json:"hero_stat3_label"`
	HeroStat4Number     string    `json:"hero_stat4_number"`
	HeroStat4Label      string    `json:"hero_stat4_label"`
	...
	ProcessSectionTitle string    `json:"process_section_title"`
	ProcessTabs         string    `json:"process_tabs" gorm:"type:text"` // JSON string array of tabs
	CreatedAt           time.Time `json:"created_at"`
	UpdatedAt           time.Time `json:"updated_at"`
}
