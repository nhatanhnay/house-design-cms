...
DROP INDEX IF EXISTS public.idx_visitors_ip_date;
...
DROP INDEX IF EXISTS public.idx_product_images_display_order;
DROP INDEX IF EXISTS public.idx_consultations_status;
DROP INDEX IF EXISTS public.idx_consultations_created_at;
...
ALTER TABLE IF EXISTS ONLY public.home_content DROP CONSTRAINT IF EXISTS home_content_pkey;
ALTER TABLE IF EXISTS ONLY public.global_seo_settings DROP CONSTRAINT IF EXISTS global_seo_settings_pkey;
ALTER TABLE IF EXISTS ONLY public.footer_content DROP CONSTRAINT IF EXISTS footer_content_pkey;
...
ALTER TABLE IF EXISTS public.global_seo_settings ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.footer_content ALTER COLUMN id DROP DEFAULT;
...
DROP SEQUENCE IF EXISTS public.global_seo_settings_id_seq;
DROP TABLE IF EXISTS public.global_seo_settings;
DROP SEQUENCE IF EXISTS public.footer_content_id_seq;
DROP TABLE IF EXISTS public.footer_content;
DROP VIEW IF EXISTS public.daily_unique_visitors;
...
--
-- Name: daily_unique_visitors; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: global_seo_settings; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: global_seo_settings_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: global_seo_settings_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: visitor_stats; Type: VIEW; Schema: public; Owner: -
--
...
--
-- Name: global_seo_settings id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Data for Name: global_seo_settings; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Name: global_seo_settings_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: global_seo_settings global_seo_settings_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_visitors_ip_date; Type: INDEX; Schema: public; Owner: -
--
